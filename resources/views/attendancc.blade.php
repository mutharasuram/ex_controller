...
@endif
          <div class="card">
            <div class="card-body">
              ...
              <center>  <form class="row g-3  needs-validation"action="{{url('view_attt')}}"method="post" novalidate>
            @csrf
            <input name="section"value="{{$section}}"hidden>
              ...
              <div class="col-md-4">
                  ...
                  <select class="form-select" name="Module" id="validationCustom04" required>
                    <option selected disabled value="">Choose...</option>
                    @foreach($data1 as $ddd)
                    <option>{{$ddd->assimod}}</option>
                    @endforeach
                  </select>
